...
module CalState
  module Packager
    #
    # Proquest metadata fixer
    #
    class Proquest
      #
      # New Proquest metadata fixer
      #
      def initialize
        @namespaces = {
      ...
      # @return [Hash]
      #
      def get_attribute(sword_mets_file)
      ...
      def unzip_sword(dom, unpacked_dir)
        ...
        result = unzip_package(unpacked_dir + '/' + sword_zip, sword_dir)
      ...
      #
      def unzip_package(zip_file, output_dir)
