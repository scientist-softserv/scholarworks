  ...
  module BreadcrumbsForWorks
    ...
    private
      ...
      def add_breadcrumb_for_action
        case action_name
        when 'edit'.freeze
          add_breadcrumb ActionView::Base.full_sanitizer.sanitize(curation_concern.to_s), main_app.polymorphic_path(curation_concern)
          add_breadcrumb t(:'hyrax.works.edit.breadcrumb'), request.path
        when 'new'.freeze
          add_breadcrumb t(:'hyrax.works.create.breadcrumb'), request.path
        when 'show'.freeze
          add_breadcrumb ActionView::Base.full_sanitizer.sanitize(presenter.to_s), main_app.polymorphic_path(presenter)
        end
      end
  end
end
