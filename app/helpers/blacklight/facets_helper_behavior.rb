...
module Blacklight::FacetsHelperBehavior
  ...
  ##
  # Render a collection of range facet fields.
  # @see #render_facet_limit
  #      Making all the range facet to use partial facet_limit
  # @return String
  def render_range_facet_partials fields = facet_field_names_for_range, options = {:partial => 'facet_limit'}
