...
module Hyrax
  ...
  class DatasetForm < Hyrax::Forms::WorkForm
    ...
    self.terms += [:resource_type_dataset, :sponsor, :date_issued, :alternative_title,
     ...
     :bibliographic_citation, :description, :description_note, :creator_email, :creator_orcid, :creator_institution, :discipline]
    ...
    def secondary_terms
      [:discipline, :alternative_title, :contributor, :publisher, :sponsor, :date_issued, :language,
