...
ActiveRecord::Schema.define(version: 2023_10_26_201730) do
  ...
  create_table "stats_file_downloads", force: :cascade do |t|
    t.string "file_id"
    t.string "work_id"
    t.string "ip_address"
    t.string "country"
    ...
    t.float "longitude"
    t.string "source"
    t.index ["file_id"], name: "index_stats_file_downloads_on_file_id"
    t.index ["work_id"], name: "index_stats_file_downloads_on_work_id"
  end

  create_table "stats_work_views", force: :cascade do |t|
    t.string "work_id"
    t.string "ip_address"
    t.string "country"
    t.string "city"
    ...
    t.float "longitude"
    t.string "source"
    t.index ["work_id"], name: "index_stats_work_views_on_work_id"
  end
